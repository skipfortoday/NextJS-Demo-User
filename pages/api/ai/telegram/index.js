...
//       bot.sendMessage(
//         msg.chat.id,
//         `Judul Berita : ${response.data.body[0].title.en} , Coin :  ${response.data.body[0].coins[0].fullname}, Tanggal Event : ${response.data.body[0].date_event}, Sumber : ${response.data.body[0].source}`,
//         {
//           reply_to_message_id: msg.message_id,
//         }
//       );
...
export default function handler(req, res) {
  res.status(200).json({ name: "Next.js 1" });
}
